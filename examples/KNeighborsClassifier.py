...
def training(data):
    ...
    print('准确性:', metrics.accuracy_score(y_test, pre_y_test))
    print('精度：', metrics.precision_score(y_test, pre_y_test))
    print('召回率：', metrics.recall_score(y_test, pre_y_test))
    print('F分数：', metrics.f1_score(y_test, pre_y_test))

    print('report：', metrics.classification_report(y_test, pre_y_test))
